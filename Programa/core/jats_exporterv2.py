...
def build_jats_xml(
    *,
    ...
    `metadatos` (opcional) son los valores editoriales que el usuario revisó
    y/o corrigió manualmente en el panel "Metadatos" (volumen, número, año,
    páginas, DOI, ISSN, idioma, fechas de manuscrito). Cuando un campo viene
    presente y no vacío en `metadatos`, tiene prioridad sobre lo que esta
    función detectaría por su cuenta a partir de los bloques del PDF; el
    detector automático solo se usa como respaldo para los campos ausentes.
    """
    ...
    issn_val = issn_manual or _extract_issn(bks)
